...
export class AddTourComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private fb: FormBuilder, private tourService: TourService) { }
  ...
  editTour() {
    this.tourService.editTour(this.tourForm.value).subscribe((response: any) => {
      if (response.status === 'success' && response.data.tour) {
        this.navigateToTourList();
      }
    });
